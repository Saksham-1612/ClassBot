...
def onehr(var1):
    ...
    driver.find_element(By.CSS_SELECTOR, 'input[type="password"]').send_keys('December@1612')
    WebDriverWait(driver, 10)
...
schedule.every().monday.at("16:03").do(onehr, c1)
...
schedule.every().saturday.at("09:03").do(onehr, c3)
schedule.every().saturday.at("10:03").do(onehr, c3)
schedule.every().saturday.at("12:03").do(twohr, c3)
schedule.every().saturday.at("13:03").do(onehr, c3)
